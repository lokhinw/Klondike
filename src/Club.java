...
public class Club extends Suit
{
	...
	c.setColor (getColor ());
	c.fillOval (pointsX [3], pointsY [3], width / 2, height / 2);
	c.fillOval (pointsX [4], pointsY [4], width / 2, height / 2);
	c.fillOval (centerX - width / 4, centerY - 4 * (height / 7), width / 2, height / 2);
